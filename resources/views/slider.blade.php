...
<section id="hero">
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <!-- Slide 1 -->
            <div class="carousel-item active" style="background-image: url({{ asset('imgs/banner1_070152.jpg') }})">
                <div class="container">
            ...
            <!-- Slide 2 -->
            <div class="carousel-item" style="background-image: url({{ asset('imgs/banner2_050914.png') }})">
                <div class="container">
            ...
            <!-- Slide 3 -->
            <div class="carousel-item" style="background-image: url({{ asset('imgs/banner3_050856.png') }})">
                <div class="container">
